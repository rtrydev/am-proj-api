...
from infrastructure.repositories.postgres.postgres_question_answers_repository import PostgresQuestionAnswersRepository
...
from infrastructure.repositories.postgres.postgres_waypoint_event_repository import PostgresWaypointEventRepository
